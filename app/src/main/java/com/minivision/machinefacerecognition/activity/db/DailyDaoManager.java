...
public class DailyDaoManager {
    private volatile static DailyDaoManager manager;
    private static DaoMaster daoMaster;
    private static DaoMaster.DevOpenHelper openHelper;
    private static DaoSession daoSession;
    private final static String NAME_DB = "daily";


    public static DailyDaoManager getInstance() {
        if (manager == null) {
            synchronized (DailyDaoManager.class) {
                if (manager == null) {
                    manager = new DailyDaoManager();
                }
            }
        }
        return manager;
